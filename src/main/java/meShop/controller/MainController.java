...
public class MainController {
	...
	@GetMapping("/search/{key}") 
	  public ResponseEntity searchByKey(@PathVariable("key") String key) {
		Map<String, Object> map = new LinkedHashMap<String, Object>();
		map.put("status", 1);
		map.put("data", productService.getProductsByKey(key));
	...
	public String getHomePage(Model model) {
		...
		if(cookieService.get("USERNAME")!=null) {
			...
			sessionService.set("USERNAME", cookieService.getValue("USERNAME", ""));
		} else
