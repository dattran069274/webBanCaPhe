...
function validateFormDelete(productName){
	...
	return retVal;
	//<td><button th:onclick="showConfirmDeleteProduct([[${product.id}]],[[${product.title}]])">Xóa</button></td>
	//onsubmit="return showConfirmDeleteProduct([[${product.title}]])"
}
...
function showInfoForm(userName,fullName){
	...
	//<label>Name</label> <input  type='text' th:value='${userList[0].getId()}'>
}